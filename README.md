...
- **[UserManagement Ecosystem](https://github.com/Andre1Freitas/UserManagement):** De uma aplicação Console a uma Web API com persistência em SQLite, focando em evolução de arquitetura e desacoplamento.

---

### 🌱 Atualmente aprendendo
- Testes de Integração em .NET
- Mensageria (RabbitMQ)
